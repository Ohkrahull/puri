...
const SpecialReqTable = () => {
  const [bookings, setBookings] = useState([
    { name: "Marvin McKinney", slotTime:"01:00 AM - 02:00 AM", slotDate: "8 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...",status: "Seen"},
    { name: "Jane Cooper", slotTime:"04:00 AM - 05:00 AM", slotDate: "9 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending"},
    { name: "Robert Fox", slotTime:"04:00 AM - 05:00 AM", slotDate: "10 Sep, 2020", amenity: "Gym" ,Feedback: "Development in previous...",status: "Seen"},
    { name: "Jenny Wilson", slotTime:"04:00 AM - 05:00 AM", slotDate: "11 Sep, 2020", amenity: "Yoga studio" ,Feedback: "Development in previous...", status: "Pending"},
    { name: "Wade Warren", slotTime: "04:00 AM - 05:00 AM", slotDate: "12 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...",status: "Seen"},
    { name: "Esther Howard", slotTime:"04:00 AM - 05:00 AM", slotDate: "13 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending"},
    { name: "Cameron Williamson", slotTime: "04:00 AM - 05:00 AM", slotDate: "14 Sep, 2020", amenity: "Gym",Feedback: "Development in previous..." , status: "Pending"},
    { name: "Brooklyn Simmons", slotTime: "04:00 AM - 05:00 AM", slotDate: "15 Sep, 2020", amenity: "Yoga studio",Feedback: "Development in previous..." ,status: "Seen"},
    { name: "Leslie Alexander", slotTime:"04:00 AM - 05:00 AM", slotDate: "16 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...", status: "Pending"},
    { name: "Guy Hawkins", slotTime: "04:00 AM - 05:00 AM", slotDate: "17 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending"},
  ]);
  ...
  const dropdownItemStyle = {
   ...
   const handleSaveEdit = (updatedBooking) => {
    const updatedBookings = bookings.map((booking, index) => 
      index === editingIndex ? updatedBooking : booking
    );
    setBookings(updatedBookings);
    setFilteredBookings(updatedBookings);
