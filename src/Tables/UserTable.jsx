      ...
      {showDropdown && filteredUsers.length > 0 && (
        <div className="absolute w-full mt-3 bg-white border border-gray-200 rounded-md shadow-lg z-10">
          {filteredUsers.map((user, index) => (
            ...
            >
              <div className="font-medium" style={{fontSize:'16px', color:'#6B7280'}}>{user.name}</div>
...
const SpecialReqTable = () => {
  const [users, setUsers] = useState([
    { name: "Marvin McKinney", slotTime:"01:00 AM - 02:00 AM", slotDate: "8 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...",status: "Seen", wingA: 'A wing', wingB: 'B wing' ,phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User",},
    { name: "Jane Cooper", slotTime:"04:00 AM - 05:00 AM", slotDate: "9 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending", wingA: 'A wing', wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "Client", },
    { name: "Robert Fox", slotTime:"04:00 AM - 05:00 AM", slotDate: "10 Sep, 2020", amenity: "Gym" ,Feedback: "Development in previous...",status: "Seen",phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User",},
    { name: "Jenny Wilson", slotTime:"04:00 AM - 05:00 AM", slotDate: "11 Sep, 2020", amenity: "Yoga studio" ,Feedback: "Development in previous...", status: "Pending",wingB: 'B wing' ,phoneNumber: "123-456-7890", email: "marvin@example.com", role: "Admin",},
    { name: "Wade Warren", slotTime: "04:00 AM - 05:00 AM", slotDate: "12 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...",status: "Seen",wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User", },
    { name: "Esther Howard", slotTime:"04:00 AM - 05:00 AM", slotDate: "13 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending",wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User", },
    { name: "Marvin McKinney", slotTime:"01:00 AM - 02:00 AM", slotDate: "8 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...",status: "Seen", wingA: 'A wing', wingB: 'B wing' ,phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User",},
    { name: "Jane Cooper", slotTime:"04:00 AM - 05:00 AM", slotDate: "9 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending", wingA: 'A wing', wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "Client", },
    { name: "Robert Fox", slotTime:"04:00 AM - 05:00 AM", slotDate: "10 Sep, 2020", amenity: "Gym" ,Feedback: "Development in previous...",status: "Seen",phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User",},
    { name: "Jenny Wilson", slotTime:"04:00 AM - 05:00 AM", slotDate: "11 Sep, 2020", amenity: "Yoga studio" ,Feedback: "Development in previous...", status: "Pending",wingB: 'B wing' ,phoneNumber: "123-456-7890", email: "marvin@example.com", role: "Admin",},
    ...
    { name: "Wade Warren", slotTime: "04:00 AM - 05:00 AM", slotDate: "12 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...",status: "Seen",wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User", },
    { name: "Esther Howard", slotTime:"04:00 AM - 05:00 AM", slotDate: "13 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending",wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User", },
    { name: "Cameron Williamson", slotTime: "04:00 AM - 05:00 AM", slotDate: "14 Sep, 2020", amenity: "Gym",Feedback: "Development in previous..." , status: "Pending",wingB: 'B wing', wingC: 'C wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User", },
    { name: "Brooklyn Simmons", slotTime: "04:00 AM - 05:00 AM", slotDate: "15 Sep, 2020", amenity: "Yoga studio",Feedback: "Development in previous..." ,status: "Seen", wingA: 'A wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User",},
    { name: "Leslie Alexander", slotTime:"04:00 AM - 05:00 AM", slotDate: "16 Sep, 2020", amenity: "Swimming pool" ,Feedback: "Development in previous...", status: "Pending", wingC: 'C wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User",},
    { name: "Guy Hawkins", slotTime: "04:00 AM - 05:00 AM", slotDate: "17 Sep, 2020", amenity: "Tennis court" ,Feedback: "Development in previous...", status: "Pending", wingA: 'A wing', wingB: 'B wing',phoneNumber: "123-456-7890", email: "marvin@example.com", role: "User", },
  ]);
 ...
 const handleDeleteSelected = () => {
  const updatedUsers = users.filter((_, index) => !selectedRows.includes(index));
    ...
    <>
     ...
     <div className="mt-1 bg-white border rounded-lg overflow-hidden flex flex-col" style={{ height: '500px' }}>
      ...
      <div className="sticky top-0 z-20 bg-white">
        {/* Keep the existing search and sort buttons */}
        <div className="flex justify-between p-6">
        {/* ... */}
        <div className='relative z-40'>
        <SearchInput users={users} onSearch={handleSearch} onItemClick={handleItemClick} />
        {/* <NextSearchInput onItemClick={handleItemClick} onSearch={handleSearch} users={users} /> */}
         ...
         <button 
                ...
                {isRoleDropdownOpen && (
                  <div style={dropdownContentStyle}>
                    {['Sort Role', 'User', 'Client', 'Admin'].map((role, index) => (
                      <div
                        key={index}
                        onClick={() => handleRoleSelect(role)}
                        style={{
                          ...dropdownItemStyle,
                          borderBottom: index === 3 ? 'none' : '1px solid var(--Gray-100, #E5E7EB)'
                        }}
                      >
                        {role}
                      </div>
        ...
        <table className="w-full text-sm text-gray-500">
          ...
          <th scope="col" className="justify-center text-center">
            ...
            <CheckboxWithTick
                      ...
                      />
{/* <span style={{width:'20px', height:'20px', padding:'1px', marginLeft:'5px', border:'1px solid #6B7280', gap:'8px', alignItems:'center', borderRadius:'6px'}}></span> */}
            </div>
          </th>
          ...
          <th scope="col" className="px-6 py-3">
            <div className="flex text-center items-center float-right">
              Role
  ...
  >
    Delete All
      ...
      <table className="w-full text-sm text-gray-500">
          <tbody>
            {/* Map through bookings and render rows */}
            {/* ... */}
      ...
      currentItems.map((user, index) => {
        ...
        return (
                <tr key={index} className="bg-white border-b hover:bg-gray-50" style={{fontSize:'14px'}}>
                  ...
                  <svg  onClick={() => handleEditClick(user, actualIndex)} style={{cursor:'pointer'}} className="ml-6" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.7586 5.73201L14.268 2.24061C14.1519 2.1245 14.0141 2.0324 13.8624 1.96957C13.7107 1.90673 13.5482 1.87439 13.384 1.87439C13.2198 1.87439 13.0572 1.90673 12.9056 1.96957C12.7539 2.0324 12.6161 2.1245 12.5 2.24061L2.86641 11.875C2.74983 11.9906 2.65741 12.1283 2.59451 12.28C2.5316 12.4317 2.49948 12.5944 2.50001 12.7586V16.25C2.50001 16.5815 2.6317 16.8994 2.86612 17.1339C3.10054 17.3683 3.41849 17.5 3.75001 17.5H7.24141C7.40563 17.5005 7.5683 17.4684 7.71999 17.4055C7.87168 17.3426 8.00935 17.2502 8.12501 17.1336L17.7586 7.49998C17.8747 7.3839 17.9668 7.24609 18.0296 7.09442C18.0925 6.94274 18.1248 6.78017 18.1248 6.616C18.1248 6.45182 18.0925 6.28925 18.0296 6.13758C17.9668 5.9859 17.8747 5.84809 17.7586 5.73201ZM7.24141 16.25H3.75001V12.7586L10.625 5.88358L14.1164 9.37498L7.24141 16.25ZM15 8.49061L11.5086 4.99998L13.3836 3.12498L16.875 6.61561L15 8.49061Z" fill="#6B7280"/>
                    ...
                    <svg  onClick={() => handleDeleteClick(actualIndex)} style={{cursor:'pointer'}}  className="ml-6" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
