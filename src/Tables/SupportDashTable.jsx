...
// // // export default SupportDashTable;
...
// //         <h2 className="text-2xl font-medium mb-1">Support</h2>
// //         <p className="text-[#6B7280] text-sm">View all your tickets</p>
// //       </div>
...
// //               <th className="px-6 py-4 text-sm font-normal text-left text-[#6B7280]">Name</th>
// //               <th className="px-6 py-4 text-sm font-normal text-left text-[#6B7280]">Ticket ID</th>
// //               <th className="px-6 py-4 text-sm font-normal text-left text-[#6B7280]">Flat Number</th>
// //             </tr>
// //           </thead>
...
// //                   {support.userInfo?.firstName} {support.userInfo?.lastName}
// //                 </td>
// //                 <td className="px-6 py-4 text-sm text-gray-900">
// //                   #{support.ticketId || 'N/A'}
// //                 </td>
// //                 <td className="px-6 py-4 text-sm text-gray-900">
// //                   {support.userInfo?.wing}-{support.userInfo?.flatNumber}
// //                 </td>
// //               </tr>
// //             ))}
// //             {supportData.length === 0 && (
// //               <tr>
// //                 <td colSpan="3" className="text-center py-12 text-[#6B7280]">
// //                   No tickets found
// //                 </td>
// //               </tr>
// //             )}
...
//   return (
//     <div className="bg-white rounded-lg h-[500px] flex flex-col border border-gray-200">
//       {/* Header */}
//       <div className="px-6 pt-6 pb-4">
//         <h2 className="text-xl font-semibold mb-1">Support</h2>
//         <p className="text-sm text-gray-500 mb-3">View all your tickets</p>
...
//               className={`relative cursor-pointer pb-2 text-[13px] font-medium ${
//                 activeTab === tab
...
//               <th className="text-left px-6 py-3 whitespace-nowrap text-md text-gray-500 font-normal" style={{fontSize:'12px'}}>Name</th>
//               <th className="text-left px-6 py-3 whitespace-nowrap text-md text-gray-500 font-normal" style={{fontSize:'12px'}}>Ticket ID</th>
//               <th className="text-left px-6 py-3 whitespace-nowrap text-md text-gray-500 font-normal" style={{fontSize:'12px'}}>Flat Number</th>
//             </tr>
//           </thead>
//           <tbody>
//             {supportData.map((support, index) => (
//               <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
//                 <td className="px-6 whitespace-nowrap py-3 text-md font-medium text-gray-900">
//                   {support.userInfo?.firstName} {support.userInfo?.lastName}
//                 </td>
...
const SupportTable = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Process each document to get user details
        const supportTickets = await Promise.all(
          supportSnapshot.docs.map(async (supportDoc) => {
            ...
            // If we have phoneNumber, fetch user details from users collection
  ...
  const handleViewTicket = (ticketId) => {
    navigate(`/support_view/${ticketId}`);
  };
  ...
  const getStatusBadge = (status) => {
    ...
    return (
      <div className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full ${statusStyle.bg} ${statusStyle.text}`}>
        <div className={`w-1.5 h-1.5 rounded-full ${statusStyle.dot}`}></div>
        <span className="text-[12px] font-medium">{status ? status.charAt(0).toUpperCase() + status.slice(1) : 'Pending'}</span>
      </div>
    );
  };
    ...
    <div className="bg-white rounded-lg border border-gray-200 flex flex-col h-[500px]">
      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full border-collapse">
          <thead className="bg-gray-50 sticky top-0">
            <tr className="border-y border-gray-200">
              <th className="text-left px-6 py-3 text-[12px] font-medium text-gray-500">Name</th>
              <th className="text-left px-6 py-3 text-[12px] font-medium text-gray-500">Ticket ID</th>
              <th className="text-left px-6 py-3 text-[12px] font-medium text-gray-500">Flat Number</th>
              <th className="text-left px-6 py-3 text-[12px] font-medium text-gray-500">Category</th>
              <th className="text-left px-6 py-3 text-[12px] font-medium text-gray-500">Status</th>
              {/* <th className="text-left px-6 py-3 text-[12px] font-medium text-gray-500">Created At</th> */}
            </tr>
          </thead>
              ...
              <tr>
                <td colSpan="6" className="text-center py-12 text-gray-500">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-400">There are no support tickets to display</p>
                  </div>
                </td>
              </tr>
            )}
