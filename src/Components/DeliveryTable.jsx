...
const SearchInput = ({ visitors, onSearch, activeTab }) => {
  ...
  const filteredVisitors = visitors.filter((visitor) => {
    const isGuest = visitor.purpose?.toLowerCase() === 'delivery';
  ...
  return (
    <div className="relative w-full sm:w-[250px] md:w-[300px] z-50" style={{ fontFamily: 'Plus_Jakarta' }}>
      <div className="flex z-50 items-center justify-between p-2 sm:py-2 border border-[#D1D5DB] rounded-[10px] text-[#6B7280] text-sm sm:text-base font-['Plus_Jakarta']" style={{ backgroundColor:'#F3F3F3', fontFamily: 'Plus_Jakarta' }}>
        <input
          type="text"
          placeholder="Search"
          value={searchTerm}
