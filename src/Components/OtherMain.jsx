...
// import ExportModal from './Exports/OtherVisitor';
...
//               {activeTab === "Amenities" ? "Other" : "Services"}
//             </h1>
...
//           {activeTab === "Amenities" ? (
//             <OtherTable bookings={bookings} onEditClick={handleEditClick} onDeleteClick={deleteBooking} />
//             // <BookingServiceTable />
//           ) : (
//             <BookingServiceTable />
//           )}
