...
// import ExportModal from './Exports/Parcel';
...
//           {activeTab === "Amenities" ? (
//             <ParcelsTable bookings={bookings} onEditClick={handleEditClick} onDeleteClick={deleteBooking} />
//             // <BookingServiceTable />
//           ) : (
//             <BookingServiceTable />
//           )}
    ...
    <div className="p-2 lg:p-0 lg:ml-10">
      <div style={{ position: 'relative' }}>
        <div className={`${isMobile ? 'flex-col space-y-4' : 'flex justify-between items-center'}`} style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className={`${isMobile ? 'flex flex-row w-full' : 'flex'} items-center`}>
            <HighlightButton 
              type="secondary" 
              onClick={() => setShowExportModal(true)}
