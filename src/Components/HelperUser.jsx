...
// import ExportModal from './Exports/Helperuser';
...
//   Export
// </HighlightButton>
//             <Link to='/AddNewHelper'  style={{display: "flex", padding: "12px 24px", justifyContent: "center", alignItems: "center", borderRadius: "10px", fontSize: "16px", fontFamily: "Plus_Jakarta", backgroundColor: "#030712", color: "#fff"}}>
//               <span>
...
//                 </svg>
//               </span>
//               {activeTab === "Amenities" ? "Add Helper" : "Add Service"}
//             </Link>
//           </div>
//         </div>
//       </div>
...
//           {activeTab === "Amenities" ? (
//             <HelperMainTable bookings={bookings} onEditClick={handleEditClick} onDeleteClick={deleteBooking} />
//             // <BookingServiceTable />
//           ) : (
//             <BookingServiceTable />
//           )}
...
const HelperUser = () => {
  ...
  const handleAddHelper = () => {
    // Navigate to add new helper page
    window.location.href = '/AddNewHelper';
  };
    ...
    <div className="p-2 lg:p-0 lg:ml-10">
      <div style={{ position: 'relative' }}>
        <div className={`${isMobile ? 'flex-col space-y-4' : 'flex justify-between items-center'}`} style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className={`${isMobile ? 'flex justify-between w-full' : 'flex items-center space-x-2'}`}>
            <HighlightButton 
              type="secondary" 
              onClick={() => setShowExportModal(true)}
