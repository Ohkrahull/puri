    ...
    return currentItems.map((request, index) => {
      ...
      return (
        <tr key={request.id} className="bg-white border-b hover:bg-gray-50" style={{fontSize:'14px'}}>
          ...
          {/* <td className="px-6 py-4 text-center" style={{width: '20%'}}>
          ...
          <td className="px-6 py-4 text-right" style={{width: '40%'}}>
            <div className="flex justify-end">
              <svg 
               onClick={() => handleDeleteClick(request.id, `${request.userInfo?.firstName || ''} ${request.userInfo?.lastName || ''}`)}
          ...
          <table className="w-full text-sm text-gray-500">
            <thead className="text-xs text-gray-500 sticky top-0 z-10 bg-gray-50" style={{fontSize:'12px'}}>
              <tr className="border-y">
                ...
                <th scope="col" className="px-6 py-4 text-left" style={{width: '30%'}}>Request</th>
                {/* <th scope="col" className="px-6 py-3 text-right" style={{width: '15%'}}>
                  <span 
                    style={{
