...
const AddService = ({ onClose, onSave, booking }) => {
  ...
  const options = ["Swimming pool", "Tennis court", "Yoga studio", "Gym"];
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white rounded-2xl w-[428px]" style={{fontFamily:'Plus Jakarta Sans, sans-serif'}}>
