          ...
          <thead className="text-xs text-gray-500 bg-gray-50 sticky top-0" style={{fontSize:'12px'}}>
            <tr>
              ...
              {selectedRows.length > 0 ? (
                ...
                <>
                  <th className="px-6 py-3 text-left text-xs text-gray-500  font-bold whitespace-nowrap" style={{color:'#4B5563', fontSize:12,}}>Name</th>
                  <th className="px-6 py-3 text-left text-xs  text-gray-500  font-bold whitespace-nowrap" style={{color:'#4B5563', fontSize:12}}>
                    Entry Code
                  </th>
                  <th 
                    className="px-6 py-3 text-left text-xs  text-gray-500 font-bold  cursor-pointer whitespace-nowrap"
                  ...
                  <th className="px-6 py-3 text-left text-xs  font-bold text-gray-500 whitespace-nowrap" style={{color:'#4B5563', fontSize:12}}>
                    Flat Number
                  </th>
