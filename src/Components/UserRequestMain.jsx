...
//               {activeTab === "Amenities" ? "User Requests" : "Services"}
//             </h1>
//             <p className="gap-2 mr-1" style={{fontSize: "17px", color: "var(--Gray-400, #6B7280)", fontStyle: "normal", fontWeight: "500", lineHeight: "28px"}}>
//               {activeTab === "Amenities" 
//                 ? "Manage all your requests from one place."
...
//           {activeTab === "Amenities" ? (
//             <UserRequestTable bookings={bookings} onEditClick={handleEditClick} onDeleteClick={deleteBooking} />
//             // <BookingServiceTable />
//           ) : (
//             <BookingServiceTable />
//           )}
    ...
    <div className="p-2 lg:p-0 lg:ml-10">
      <div style={{ position: 'relative' }}>
        <div className={`${isMobile ? 'flex-col space-y-4' : 'flex justify-between items-center'}`} style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className={`${isMobile ? 'w-full' : 'flex'} justify-end items-center`}>
            <HighlightButton 
              type="secondary" 
              onClick={() => setShowExportModal(true)}
              className={isMobile ? 'w-full justify-center mb-2' : ''}
            >
              <ExportIcon />
              Export
