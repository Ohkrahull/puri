...
// import "../App.css";
// import "../index.css";
// import FeedBackTableNew from "./FeedBackTableNew";
...
//         // Here you would typically update your app state or re-fetch the feedback data
//         // For example, you could have a function to refresh the FeedBackTableNew component
...
//               }}
//             >
//               Keep track of all your recent feedback in one place.
//             </p>
//           </div>
//           <div
//             style={{
...
//         onAdd={(feedbackData) => {
//           console.log('New feedback:', feedbackData);
//           // Here you might want to update your app state or re-fetch the feedback data
//           // For example, you could have a function to refresh the FeedBackTableNew component
//           // refreshFeedbackTable();
//         }}
//       />
    ...
    return (
        <>
            <div className="p-2 lg:p-0 lg:ml-10">
                ...
                <div className="mt-6 rounded-lg overflow-hidden">
                    <div className="overflow-x-auto">
                        <FeedBackTableNew isMobile={isMobile} />
                    </div>
                </div>
            </div>
