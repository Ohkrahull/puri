...
// import ExportModal from './Exports/GuardUser';
...
// import HelperMainTable from "./HelperMainTable";
// import GuardTable from "./GuardMainTable";
...
//   Export
// </HighlightButton>
//             <Link to='/AddNewGuard'  style={{display: "flex", padding: "12px 24px", justifyContent: "center", alignItems: "center", borderRadius: "10px", fontSize: "16px", fontFamily: "Plus_Jakarta", backgroundColor: "#030712", color: "#fff"}}>
//               <span>
...
//                 </svg>
//               </span>
//               {activeTab === "Amenities" ? "Add Guard" : "Add Service"}
//             </Link>
//           </div>
//         </div>
//       </div>
...
//           {activeTab === "Amenities" ? (
//             <GuardTable bookings={bookings} onEditClick={handleEditClick} onDeleteClick={deleteBooking} />
//             // <BookingServiceTable />
//           ) : (
//             <BookingServiceTable />
//           )}
...
const GuardUser = () => {
  ...
  const handleAddGuard = () => {
    ...
    window.location.href = '/AddNewGuard';
  };
    ...
    <div className="p-2 lg:p-0 lg:ml-10">
      <div style={{ position: 'relative' }}>
        <div className={`${isMobile ? 'flex-col space-y-4' : 'flex justify-between items-center'}`} style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className={`${isMobile ? 'flex   w-full justify-between' : 'flex items-center space-x-2'}`}>
            <HighlightButton 
              type="secondary" 
              onClick={() => setShowExportModal(true)}
            ...
            <Link to='/AddNewGuard' className="sm:gap-3"  style={{display: "flex", padding: "12px 24px", justifyContent: "center", alignItems: "center", borderRadius: "10px", fontSize: "16px", fontFamily: "Plus_Jakarta", backgroundColor: "#030712", color: "#fff"}}
            // type="primary"
      ...
      <div className="mt-6 rounded-lg overflow-hidden">
        <div className="overflow-x-auto">
          {activeTab === "Amenities" ? (
            ...
            <BookingServiceTable isMobile={isMobile} />
          )}
        </div>
      </div>
