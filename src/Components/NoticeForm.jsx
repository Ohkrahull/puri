...
// // // // import { toast } from 'react-toastify';
// // // // import { getApp } from 'firebase/app';
// // // // import { sendNotificationToAllUsers } from '../utils/notificationUtils';
...
// // // //         toast.success('Notice updated successfully');
// // // //       } else {
// // // //         const docRef = await addDoc(collection(db, 'notices'), noticeFormData);
// // // //         noticeId = docRef.id;
// // // //         toast.success('Notice created successfully');
// // // //       }
      
// // // //       // Send notification to all users about the notice
// // // //       const notificationTitle = `${formData.category} Notice`;
// // // //       const notificationBody = formData.heading;
// // // //       const additionalData = {
// // // //         type: 'notice',
// // // //         noticeId: noticeId,
// // // //         category: formData.category,
// // // //         description: formData.description.substring(0, 100), // First 100 chars only
...
// //   // Fallback notification function in case the imported one doesn't work
// //   const sendNotificationDirectly = async (title, body, additionalData = {}) => {
// //     try {
// //       console.log('Sending notification directly:', { title, body, additionalData });
...
// //       // Don't throw error to prevent breaking the form submission flow
// //       return { success: false, error: error.message };
// //     }
// //   };

// //   // Other functions and styles remain the same...
// //   const inputStyle = {
// //     width: "100%",
// //     padding: "14px",
// //     border: "1px solid var(--Gray-200, #E5E7EB)",
...
// //       // Try both methods to ensure notification is sent
// //       console.log('Attempting to send notification using utility function...');
// //       try {
...
// //           additionalData
// //         );
// //         console.log('Notification sent successfully via utility function');
// //       } catch (notifyError) {
// //         console.error('Error with utility function, trying direct method:', notifyError);
// //         // Fallback to direct implementation
// //         await sendNotificationDirectly(
// //           notificationTitle,
// //           notificationBody,
// //           additionalData
// //         );
// //         console.log('Notification sent successfully via direct method');
// //       }
...
//   // Direct implementation of sendNotificationToAllUsers - same as in Construction_add_up_right
...
//       try {
//         console.log('Preparing to send notification for the notice...');
//         const notificationTitle = `${formData.category} Notice`;
//         const notificationBody = formData.heading;
...
//         // Don't stop execution on notification failure
//       }
...
const NoticeForm = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    if (file && file.size <= 5 * 1024 * 1024) {
      ...
      try {
        ...
        console.log('Attachment URL set:', downloadURL); // Add this log
        toast.success('File uploaded successfully');
      } catch (error) {
        console.error('Error uploading file:', error);
        toast.error('Failed to upload file');
  ...
  const handleSubmit = async (isPinned = formData.isPinned) => {
    ...
    try {
      ...
      console.log('Final notice data being sent to Firestore:', noticeFormData);
      ...
      // Show saving success toast first
      toast.info('Sending notification to all users...');
      
      // Send notification after successful form submission
      try {
        console.log('Preparing to send notification for the notice...');
        const notificationTitle = `Notice Alert - ${formData.category}`;
        const notificationBody = formData.heading;
        await sendNotificationToAllUsers(notificationTitle, notificationBody);
        console.log('Notification sent successfully');
      } catch (notifyError) {
