...
const Users = () => {
    ...
    const renderTable = () => {
        switch(activeTab) {
            case "Members":
                return <MemberTable refreshTrigger={refreshTrigger} isMobile={isMobile} />;
            case "Staff":
                return <StaffTable refreshTrigger={refreshStaffTable} isMobile={isMobile} />;
            case "Guests":
                return <GuestTable isMobile={isMobile} />;
            default:
                return null;
        }
    };
        ...
        <>
            <div className="p-2 lg:p-0 lg:ml-10">
                <div className={`${isMobile ? 'flex-col space-y-4' : 'flex justify-between items-center'}`}>
                    ...
                    <div className={`
                        ${isMobile 
                            ? 'flex space-y-2 w-full justify-between' 
