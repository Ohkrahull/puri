...
// import ExportModal from './Exports/CabVisitor';
...
//               {activeTab === "Amenities" ? "Cab" : "Services"}
//             </h1>
...
//           {activeTab === "Amenities" ? (
//             <CabTable bookings={bookings} onEditClick={handleEditClick} onDeleteClick={deleteBooking} />
//             // <BookingServiceTable />
//           ) : (
//             <BookingServiceTable />
//           )}
